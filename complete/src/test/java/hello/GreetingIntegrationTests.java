...
//        RequestEntity.get(uri("api/greeting")).header(HttpHeaders.ORIGIN, "http://localhost:9000").build(),
//        Greeting.class);
...
//    ResponseEntity<Greeting> entity = this.restTemplate.exchange(
//        RequestEntity.get(uri("api/greeting-javaconfig")).header(HttpHeaders.ORIGIN, "http://localhost:9000").build(),
//        Greeting.class);
//    assertEquals(HttpStatus.OK, entity.getStatusCode());
//    assertEquals("http://localhost:9000", entity.getHeaders().getAccessControlAllowOrigin());
//    Greeting greeting = entity.getBody();
